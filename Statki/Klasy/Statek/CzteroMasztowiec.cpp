...
CzteroMasztowiec::CzteroMasztowiec() : Statek(4, 0, 0) {}; //Konstruktor

bool CzteroMasztowiec::ustaw_Wspolrzedne(int x, int y, int szerokosc, int wysokosc)
{
...
bool CzteroMasztowiec::czy_Mozna_Ustawic(int x, int y, int szerokosc, int wysokosc)
{
...
int CzteroMasztowiec::pobierz_Wspolrzedna_X()
{
	return x;
}
int CzteroMasztowiec::pobierz_Wspolrzedna_Y()
{
	return y;
}
int CzteroMasztowiec::pobierz_Dlugosc()
{
	return dlugosc;
}
void CzteroMasztowiec::ustaw_CzyPion(bool czy_AI)
{
	int wybor_Pozycji;
	if (czy_AI)
...
bool CzteroMasztowiec::pobierz_CzyPion()
{
	return czyPion;
}
void CzteroMasztowiec::ustaw_Statek(bool czy_AI, int szerokosc, int wysokosc)
{
	int x, y;
...
CzteroMasztowiec::~CzteroMasztowiec() { }; //Destruktor
