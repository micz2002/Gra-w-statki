...
DwuMasztowiec::DwuMasztowiec() : Statek(2, 0, 0) {}; //Konstruktor

bool DwuMasztowiec::ustaw_Wspolrzedne(int x, int y, int szerokosc, int wysokosc)
{
...
bool DwuMasztowiec::czy_Mozna_Ustawic(int x, int y, int szerokosc, int wysokosc)
{
...
int DwuMasztowiec::pobierz_Wspolrzedna_X()
{
	return x;
}
int DwuMasztowiec::pobierz_Wspolrzedna_Y()
{
	return y;
}
int DwuMasztowiec::pobierz_Dlugosc()
{
	return dlugosc;
}
void DwuMasztowiec::ustaw_CzyPion(bool czy_AI)
{
	int wybor_Pozycji;
	if (czy_AI)
...
bool DwuMasztowiec::pobierz_CzyPion()
{
	return czyPion;
}
void DwuMasztowiec::ustaw_Statek(bool czy_AI, int szerokosc, int wysokosc)
{
	int x, y;
...
DwuMasztowiec::~DwuMasztowiec() { }; //Destruktor
